...
import com.intelli5.back.domain.PersistentToken;
...
import com.intelli5.back.service.MailService;
import com.intelli5.back.service.UserService;
import com.intelli5.back.service.dto.UserDTO;
import com.intelli5.back.web.rest.vm.KeyAndPasswordVM;
import com.intelli5.back.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public ResponseEntity<String> activateAccount(@RequestParam(value = "key") String key) {
        return userService.activateRegistration(key)
            .map(user -> ResponseEntity.ok("You Account has been activated!"))
