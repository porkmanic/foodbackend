(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('foodininjaApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-foodininjaApp-error');
                var entityKey = httpResponse.headers('X-foodininjaApp-params');
                if (errorHeader) {
